...
async function convertCoverage() {
    ...
    const thresholds = {
        lines: 30, // Minimum 30% of lines must be covered
        statements: 30, // Minimum 30% of statements must be covered
        functions: 30, // Minimum 30% of functions must be covered
        branches: 30 // Minimum 30% of branches must be covered
    };
